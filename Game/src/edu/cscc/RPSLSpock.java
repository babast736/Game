...
public class RPSLSpock {
    ...
    /**
     * This method comparing the strings.
     *@return  false if condition is null.
     * @param pick refers to the strings
     */
    ...
    /**
     *  Functionality to generate random  strings.
     * condition will be effective by choosing one of the five strings.
     * @return the strings pick
     */
    ...
    /**
     * this  method changes computer picks to lowercase
     * @param c_pick the string picks by the player.
     * @param h_pick the pick of the computer
     * @return lowercase computer picks
       */
